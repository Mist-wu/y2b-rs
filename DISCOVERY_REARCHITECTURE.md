...
> [!NOTE]
> 本文归档已经合入主线的 Phase 0–4 发现架构设计。下文的 v11–v15 是各阶段当时的迁移快照，不代表当前数据库终点；当前 schema 为 **v21**，v16–v21 的 AI 审计、频道优先级、队列租约、投稿 attempt、BVID 唯一性和 CC 字幕 attempt 状态机改造不在本文范围内。部署、恢复和质量门禁以 [README](README.md) 为准。
